...
export const landing = {
  ...
  endedBadge: "Контест окончен",
  endedLabel: "Итоги контеста",
  endedChip: "Окончен",
  endedOn: "Завершён",
  ctaViewResults: "Посмотреть результаты",
  endedNotifyHint: "Следующий контест уже готовится.",
...
export const contest = {
  ...
  worksResultsTitle: "Результаты контеста",
  worksResultsHint: "Работы отсортированы по итогам проверки.",
  worksPlace: "место",
  worksNotScored: "Без оценки",
  worksVideoBonus: "включая +10 за видео",
